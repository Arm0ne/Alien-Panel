import{$i as e,Dr as t,Er as n,Ki as r,Kr as i,Qn as a,_i as o,bi as s,ea as c,gi as l,hi as u,hr as d,mi as f,mr as p,ni as m,pi as h,vi as g,yi as _}from"./router-CCMKz-_h.js";import{a as v}from"./index-DjO2buBc.js";function y(e,t=`default`,n=[]){let{children:r}=e;if(typeof r==`object`&&r&&!Array.isArray(r)){let e=r[t];if(typeof e==`function`)return e()}return n}var b=h([f(`descriptions`,{fontSize:`var(--n-font-size)`},[f(`descriptions-separator`,`
