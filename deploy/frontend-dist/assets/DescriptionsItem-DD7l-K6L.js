import{$r as e,Dr as t,Mi as n,Nn as r,Qr as i,Rr as a,Vi as o,Xn as s,Zn as c,Zr as l,cr as u,ei as d,ii as f,ni as p,ri as m,ti as h,zi as g}from"./router-Dz01zSsj.js";import{n as _}from"./Space-DhGnYd6O.js";import{s as v}from"./index-Djh37NU9.js";function y(e,t=`default`,n=[]){let{children:r}=e;if(typeof r==`object`&&r&&!Array.isArray(r)){let e=r[t];if(typeof e==`function`)return e()}return n}var b=l([i(`descriptions`,{fontSize:`var(--n-font-size)`},[i(`descriptions-separator`,`
