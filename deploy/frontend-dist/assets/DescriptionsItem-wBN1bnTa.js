import{$r as e,Dr as t,Mi as n,Nn as r,Qr as i,Rr as a,Vi as o,Xn as s,Zn as c,Zr as l,cr as u,ei as d,ii as f,ni as p,ri as m,ti as h,zi as g}from"./router-D5KR2eJ2.js";import{n as _}from"./Space-COlWxkwH.js";import{s as v}from"./index-9m1J7-fZ.js";function y(e,t=`default`,n=[]){let{children:r}=e;if(typeof r==`object`&&r&&!Array.isArray(r)){let e=r[t];if(typeof e==`function`)return e()}return n}var b=l([i(`descriptions`,{fontSize:`var(--n-font-size)`},[i(`descriptions-separator`,`
