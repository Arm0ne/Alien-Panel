import{$n as e,$r as t,Br as n,Fn as r,Pi as i,Qn as a,Ui as o,Vi as s,ai as c,ei as l,ii as u,kr as d,ni as f,oi as p,ri as m,ti as h,ur as g}from"./router-BQSgyjEO.js";import{n as _}from"./Space-CgVBgFsH.js";import{s as v}from"./index-Pq8xBtfs.js";function y(e,t=`default`,n=[]){let{children:r}=e;if(typeof r==`object`&&r&&!Array.isArray(r)){let e=r[t];if(typeof e==`function`)return e()}return n}var b=t([l(`descriptions`,{fontSize:`var(--n-font-size)`},[l(`descriptions-separator`,`
