import{Bi as e,Fr as t,Kr as n,Vn as r,Yi as i,ai as a,ar as o,ci as s,di as c,fi as l,gr as u,ir as d,li as f,oi as p,qi as m,si as h,ui as g}from"./router-C4wCC4tn.js";import{n as _}from"./Space-J1ldTdAO.js";import{s as v}from"./index-Bv7JPY8-.js";function y(e,t=`default`,n=[]){let{children:r}=e;if(typeof r==`object`&&r&&!Array.isArray(r)){let e=r[t];if(typeof e==`function`)return e()}return n}var b=a([p(`descriptions`,{fontSize:`var(--n-font-size)`},[p(`descriptions-separator`,`
