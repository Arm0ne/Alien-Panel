import{Ci as e,Ei as t,Mr as n,Nr as r,Qi as i,Qr as a,Si as o,Ti as s,aa as c,bi as l,br as u,ci as d,ir as f,oa as p,wi as m,xi as h,xr as g,yi as _}from"./router-CGMPUmYf.js";import{a as v}from"./index-1M4Kl-DU.js";function y(e,t=`default`,n=[]){let{children:r}=e;if(typeof r==`object`&&r&&!Array.isArray(r)){let e=r[t];if(typeof e==`function`)return e()}return n}var b=_([l(`descriptions`,{fontSize:`var(--n-font-size)`},[l(`descriptions-separator`,`
