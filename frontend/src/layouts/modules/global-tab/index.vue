...
async function scrollToActiveTab() {
  ...
  for (let i = 0; i < children.length; i += 1) {
    ...
    // The tab component can briefly render a placeholder node while a route
    // transition is being committed. Avoid dereferencing a missing
    // attribute during that window; an uncaught error here breaks the layout
    // and makes the whole menu appear unresponsive.
