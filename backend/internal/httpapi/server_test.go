...
func TestNodeDetailAndManualSyncRequest(t *testing.T) {
	...
	statements := []struct {
		...
		{`INSERT INTO inbounds (id, node_id, remote_inbound_id, kind, tag, protocol, port, enable, client_count, up, down, all_time, first_seen_at, last_seen_at, deleted_at) VALUES ('node-archived-inbound', 'node-detail', '8', 'infrastructure', 'ss-deleted', 'shadowsocks', 8444, 1, 2, 1, 2, 3, ?, ?, ?)`, []any{nowText, nowText, nowText}},
